...
export const MAINTENANCE_TRANSLATIONS: Record<string, TranslationEntry> = {
  ...
  'maintenance.colSerial': { en: '#', ar: 'مسلسل' },
  'maintenance.colVehicleType': { en: 'Vehicle Type', ar: 'النوع' },
  'maintenance.colDepartment': { en: 'Department', ar: 'الإدارة' },
  'maintenance.closedAt': { en: 'Exit Date', ar: 'تاريخ الخروج' },
  'maintenance.repairStatement': { en: 'Repair Description', ar: 'بيان الإصلاح' },
  'maintenance.relatedDocument': { en: 'Related Document', ar: 'المستند المرتبط' },
  'maintenance.statusInProgress': { en: 'In Progress', ar: 'قيد التنفيذ' },
  'maintenance.statusCompleted': { en: 'Completed', ar: 'مكتملة' },
  'maintenance.statusPending': { en: 'Pending', ar: 'معلقة' },
  'maintenance.docCheck': { en: 'Check', ar: 'شيك' },
  'maintenance.docPettyCash': { en: 'Petty Cash', ar: 'عهدة' },
  'maintenance.docDisbursement': { en: 'Disbursement', ar: 'طلب صرف' },
  'maintenance.docInvoice': { en: 'Invoice', ar: 'فاتورة' },
  'maintenance.filterVehicle': { en: 'Vehicle', ar: 'رقم السيارة' },
  'maintenance.filterStatus': { en: 'Status', ar: 'الحالة' },
  'maintenance.filterDepartment': { en: 'Department', ar: 'الإدارة' },
  'maintenance.filterTechnician': { en: 'Technician', ar: 'الفني' },
  'maintenance.filterMaintenanceType': { en: 'Maintenance Type', ar: 'نوع الصيانة' },
  'maintenance.filterOpenedFrom': { en: 'Entry from', ar: 'دخول من' },
  'maintenance.filterOpenedTo': { en: 'Entry to', ar: 'دخول إلى' },
  'maintenance.filterClosedFrom': { en: 'Exit from', ar: 'خروج من' },
  'maintenance.filterClosedTo': { en: 'Exit to', ar: 'خروج إلى' },
  'maintenance.type.routine': { en: 'Routine', ar: 'دورية' },
  'maintenance.type.major_overhaul': { en: 'Major Overhaul', ar: 'عمرة كبرى' },
  'maintenance.type.emergency': { en: 'Emergency', ar: 'طارئة' },
  'maintenance.type.external': { en: 'External', ar: 'خارجية' },
  'maintenance.editWorkOrderTitle': { en: 'Edit Work Order', ar: 'تعديل أمر شغل' },
  'maintenance.externalWorkshopFlag': {
    en: 'Performed at external workshop',
    ar: 'تتم في ورشة خارجية',
  },
  'maintenance.selectTechnicians': { en: 'Select technicians…', ar: 'اختر الفنيين…' },
  'maintenance.deleteWorkOrderConfirm': {
    en: 'Delete work order for vehicle',
    ar: 'حذف أمر الشغل للسيارة',
  },
  'maintenance.failedDeleteWorkOrder': {
    en: 'Failed to delete work order.',
    ar: 'فشل حذف أمر الشغل.',
  },
  'maintenance.failedUpdateWorkOrder': {
    en: 'Failed to update work order.',
    ar: 'فشل تحديث أمر الشغل.',
  },
  'maintenance.relatedDocType': { en: 'Document Type', ar: 'نوع المستند' },
  'maintenance.relatedDocSelect': { en: 'Select Document', ar: 'اختيار المستند' },
  'maintenance.relatedDocSelectPlaceholder': {
    en: 'Select related document…',
    ar: 'اختر المستند المرتبط…',
  },
};
