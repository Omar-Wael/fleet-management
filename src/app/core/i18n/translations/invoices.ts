...
export const INVOICES_TRANSLATIONS: Record<string, TranslationEntry> = {
  ...
  'invoices.selectItemPlaceholder': { en: 'Select a previously invoiced item', ar: 'اختر بندًا سبق أن ظهر في فاتورة' },
  'invoices.modeCatalog': { en: 'From invoices', ar: 'من الفواتير' },
  'invoices.modeCustom': { en: 'Free text', ar: 'نص حر' },
  ...
  'invoices.filterVendor': { en: 'Vendor', ar: 'المورد' },
  'invoices.filterVehicle': { en: 'Vehicle', ar: 'المركبة' },
  'invoices.filterItem': { en: 'Item / Part', ar: 'الصنف' },
  'invoices.filterDepartment': { en: 'Department', ar: 'الإدارة' },
  'invoices.filterWorkshop': { en: 'Repair department', ar: 'ورشة الصيانة' },
};
